...
def it(bot, update, args):
    ...
    bot.sendMessage(update.message.chat_id, text = ("#" + str(quoteIndex) + text))
...
def main():
    ...
    updater = Updater("put your bot token here")
    ...
    dp.add_handler(CommandHandler("it", it, pass_args=True))
